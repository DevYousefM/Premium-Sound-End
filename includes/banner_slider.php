...
<div class="special-slide">
    <div class="container">
                                ...
                                <div class="text-content">
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <div class="price price-contain">
                                            <ins><span class="price-amount"><span class="currencySymbol">Eg. </span><?php echo $pdt_data['pdt_price'] ?></span></ins>
        ...
        <div class="biolife-service type01 biolife-service__type01 sm-margin-top-0 xs-margin-top-45px">
            <b class="txt-show-01">Music</b>
            <i class="txt-show-02">All Premium Sound</i>
            <ul class="services-list">
                <li>
                    <div class="service-inner color-reverse">
                        <span class="number">1</span>
                       
                        <a class="srv-name" href="#">Classic</a>
                    </div>
                </li>
                <li>
                    <div class="service-inner color-reverse">
