                                    ...
                                    <li class="product-item">
                                        <div class="contain-product deal-layout contain-product__deal-layout">
                                            ...
                                            <div class="info">
                                                ...
                                                <b class="categories">Top Music</b>
                                                <h4 class="product-title"><a href="#" class="pr-name">International songs</a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">Eg</span>85.00</span></ins>
                                                    <del><span class="price-amount"><span class="currencySymbol">Eg</span>95.00</span></del>
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message">premium music</p>
                                                    <div class="buttons">
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product deal-layout contain-product__deal-layout">
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="slide-down-box">
                                                    <p class="message">International songs.</p>
                                                    <div class="buttons">
                                                        <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                        <a href="#" class="btn add-to-cart-btn">add to cart</a>
                                                        <a href="#" class="btn compare-btn"><i class="fa fa-random" aria-hidden="true"></i></a>
