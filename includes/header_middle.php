                        ...
                        <div class="mobile-search-content">
                            <form action="#" class="form-search" name="mobile-seacrh" method="get">
                                ...
                                <select name="category">
                                    ...
                                    <option value="fresh_berries"></option>
                                    <option value="ocean_foods"></option>
                                    <option value="butter_eggs"></option>
                                    <option value="fastfood"></option>
                                    <option value="fresh_meat"></option>
                                    <option value="fresh_onion"></option>
                                    <option value="papaya_crisps"></option>
