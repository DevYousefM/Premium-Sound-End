                        ...
                        <div class="tab-head tab-head__icon-top-layout icon-top-layout">
                            <ul class="tabs md-margin-bottom-35-im xs-margin-bottom-40-im">
                                <li class="tab-element active">
                                    <a href="#tab01_1st" class="tab-link"><?php echo $array_collum['0']; ?></a>
                                </li>
                                <!-- <li class="tab-element" >
                                    <a href="#tab01_2nd" class="tab-link"><span class="biolife-icon icon-grape2"></span></span><?php echo $array_collum['1']; ?></a>
                                </li> -->
                                <li class="tab-element" >
                                    <a href="#tab01_3rd" class="tab-link"><?php echo $array_collum['2']; ?></a>
                                </li>
                                <li class="tab-element" >
                                    <a href="#tab01_4th" class="tab-link"><?php echo $array_collum['3']; ?></a>
                                </li>
                                <li class="tab-element" >
                                    <a href="#tab01_5th" class="tab-link"><?php echo $array_collum['4']; ?></a>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">Eg. </span><?php echo $eight_pdt_ctg_one['pdt_price'] ?></span></ins>
                                                    
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message">All music is unique.</p>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">Eg. </span><?php echo $eight_pdt_ctg_three['pdt_price']?></span></ins>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">Eg. </span><?php echo $eight_pdt_ctg_four['pdt_price']?></span></ins>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">Eg. </span><?php echo $eight_pdt_ctg_five['pdt_price']?></span></ins>
