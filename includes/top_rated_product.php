                                ...
                                <li class="product-item">
                                        <div class="contain-product right-info-layout contain-product__right-info-layout">
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">Eg. </span><?php echo $top_pdt['pdt_price']?></span></ins>
                                ...
                                <div class="biolife-banner style-01 biolife-banner__style-01 sm-margin-top-30px xs-margin-top-80px">
                                    <div class="banner-contain">
                                        ...
                                        <div class="text-content">
                                            <span class="first-line">Music</span>
                                            <b class="second-line">Premium</b>
                                            <i class="third-line">Sound</i>
                                            <span class="fourth-line">The best music</span>
                                        </div>
                                    </div>
                                </div>
                            </div>